# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.3 on Tue Jul 30 14:52:10 2019
#
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.notebook_3_66 = wx.Panel(self.notebook_3, wx.ID_ANY)
        ...
        self.list_box_data_folder = wx.ListBox(self.notebook_3_pane_2, wx.ID_ANY, choices=[])
        self.button_adddata = wx.Button(self.notebook_3_pane_2, wx.ID_ANY, "add data")
        self.button_update_folder = wx.Button(self.notebook_3_pane_2, wx.ID_ANY, "update_folder")
        self.list_box_currentdata = wx.ListBox(self.notebook_3_pane_2, wx.ID_ANY, choices=[])
        self.button_removedata = wx.Button(self.notebook_3_pane_2, wx.ID_ANY, "remove")
        self.button_openfolder = wx.Button(self.notebook_3_pane_2, wx.ID_ANY, "open folder")
        self.button_open_cfg = wx.Button(self.notebook_3_pane_2, wx.ID_ANY, "open cfg")
        self.list_box_parax = wx.ListBox(self.notebook_3_pane_2, wx.ID_ANY, choices=["choice 1"])
        strl1 = ["s", "time", "zero", "thetap", "thetappr", "xb1", "xb1pr", "yb1", "yb1pr", "zb1", "zb1pr","faix1", "faix1pr", "faiy1", "faiy1pr", "x1", "x1pr", "y1", "y1pr", "z1", "z1pr", "theta1x","theta1xpr", "theta1y", "theta1ypr", "theta1z", "theta1zpr", "xb2", "xb2pr", "yb2", "yb2pr", "zb2","zb2pr", "faix2", "faix2pr", "faiy2", "faiy2pr", "xb3", "xb3pr", "yb3", "yb3pr", "zb3", "zb3pr","faix3", "faix3pr", "faiy3", "faiy3pr", "x2", "x2pr", "y2", "y2pr", "z2", "z2pr", "theta2x","theta2xpr", "theta2y", "theta2ypr", "theta2z", "theta2zpr", "xb4", "xb4pr", "yb4", "yb4pr", "zb4","zb4pr", "faix4", "faix4pr", "faiy4", "faiy4pr", "thetag", "thetagpr",]
        self.list_box_parax.Set(strl1)
        self.list_box_paray = wx.ListBox(self.notebook_3_pane_2, wx.ID_ANY, choices=["choice 1"])
        strl1 = ["s", "time", "zero", "thetap", "thetappr", "xb1", "xb1pr", "yb1", "yb1pr", "zb1", "zb1pr","faix1", "faix1pr", "faiy1", "faiy1pr", "x1", "x1pr", "y1", "y1pr", "z1", "z1pr", "theta1x","theta1xpr", "theta1y", "theta1ypr", "theta1z", "theta1zpr", "xb2", "xb2pr", "yb2", "yb2pr", "zb2","zb2pr", "faix2", "faix2pr", "faiy2", "faiy2pr", "xb3", "xb3pr", "yb3", "yb3pr", "zb3", "zb3pr","faix3", "faix3pr", "faiy3", "faiy3pr", "x2", "x2pr", "y2", "y2pr", "z2", "z2pr", "theta2x","theta2xpr", "theta2y", "theta2ypr", "theta2z", "theta2zpr", "xb4", "xb4pr", "yb4", "yb4pr", "zb4","zb4pr", "faix4", "faix4pr", "faiy4", "faiy4pr", "thetag", "thetagpr",]
        self.list_box_paray.Set(strl1)
        self.button_1 = wx.Button(self.notebook_3_pane_2, wx.ID_ANY, "button_1")
        self.slider_length = wx.Slider(self.notebook_3_pane_2, wx.ID_ANY, 10000000, 0, 10000000, style=wx.SL_HORIZONTAL | wx.SL_LABELS)
        self.slider_startpoint = wx.Slider(self.notebook_3_pane_2, wx.ID_ANY, 0, 0, 1000000000, style=wx.SL_HORIZONTAL | wx.SL_LABELS)
        self.button_draw = wx.Button(self.notebook_3_pane_2, wx.ID_ANY, "DRAW")
        self.button_popupdraw1 = wx.Button(self.notebook_3_pane_2, wx.ID_ANY, "popup1")
        self.button_popupdraw2 = wx.Button(self.notebook_3_pane_2, wx.ID_ANY, "popup2")
        self.button_popupdraw3 = wx.Button(self.notebook_3_pane_2, wx.ID_ANY, "popup3")
        self.text_function = wx.TextCtrl(self.notebook_3_pane_2, wx.ID_ANY, "sin(x)", style=wx.TE_PROCESS_ENTER)
        self.text_plot_xmin = wx.TextCtrl(self.notebook_3_pane_2, wx.ID_ANY, "0", style=wx.TE_PROCESS_ENTER)
        self.text_plot_xmax = wx.TextCtrl(self.notebook_3_pane_2, wx.ID_ANY, "10", style=wx.TE_PROCESS_ENTER)
        self.text_plot_xstep = wx.TextCtrl(self.notebook_3_pane_2, wx.ID_ANY, "0.1", style=wx.TE_PROCESS_ENTER)
        self.choice_subplot = wx.Choice(self.notebook_3_pane_2, wx.ID_ANY, choices=["top left", "top right", "bottom left", "bottom right"])
        self.button_plot = wx.Button(self.notebook_3_pane_2, wx.ID_ANY, "Plot")
        self.choice_canvas_size = wx.Choice(self.notebook_3_pane_2, wx.ID_ANY, choices=["Variable", "400x300", "800x600", "1024x768", "1600x1200"])
        self.choice_subplots = wx.Choice(self.notebook_3_pane_2, wx.ID_ANY, choices=["1x1", "1x2", "2x1", "2x2", "2x3"])
        self.button_clear_plots = wx.Button(self.notebook_3_pane_2, wx.ID_ANY, "Clear plots")
        self.button_clear_figures = wx.Button(self.notebook_3_pane_2, wx.ID_ANY, "Clear figures")
        self.button_clear_all = wx.Button(self.notebook_3_pane_2, wx.ID_ANY, "Clear all")
        self.button_multicursor = wx.ToggleButton(self.notebook_3_pane_2, wx.ID_ANY, "Multicursor")
        ...
        self.Bind(wx.EVT_BUTTON, self.on_button_adddata, self.button_adddata)
        self.Bind(wx.EVT_BUTTON, self.on_button_update_folder, self.button_update_folder)
        self.Bind(wx.EVT_BUTTON, self.on_button_removedata, self.button_removedata)
        self.Bind(wx.EVT_BUTTON, self.on_button_openfolder, self.button_openfolder)
        self.Bind(wx.EVT_BUTTON, self.on_button_opencfg, self.button_open_cfg)
        self.Bind(wx.EVT_COMMAND_SCROLL, self.on_slider_length, self.slider_length)
        self.Bind(wx.EVT_COMMAND_SCROLL, self.on_slider_startpoint, self.slider_startpoint)
        self.Bind(wx.EVT_BUTTON, self.on_button_draw, self.button_draw)
        self.Bind(wx.EVT_BUTTON, self.on_button_popupdraw1, self.button_popupdraw1)
        self.Bind(wx.EVT_BUTTON, self.on_button_popupdraw2, self.button_popupdraw2)
        self.Bind(wx.EVT_BUTTON, self.on_button_popupdraw3, self.button_popupdraw3)
    ...
    def __set_properties(self):
        ...
        self.list_box_parax.SetSelection(0)
        self.list_box_paray.SetSelection(0)
        self.button_draw.SetBackgroundColour(wx.Colour(255, 122, 0))
        self.button_draw.SetFont(wx.Font(11, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, ""))
    ...
    def __do_layout(self):
        ...
        sizer_12 = wx.StaticBoxSizer(wx.StaticBox(self.notebook_3_pane_2, wx.ID_ANY, "Canvas Control"), wx.HORIZONTAL)
        sizer_8 = wx.StaticBoxSizer(wx.StaticBox(self.notebook_3_pane_2, wx.ID_ANY, "Add Function Plots"), wx.VERTICAL)
        sizer_3 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_4 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_27 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_25 = wx.StaticBoxSizer(wx.StaticBox(self.notebook_3_pane_2, wx.ID_ANY, "Param"), wx.HORIZONTAL)
        sizer_26 = wx.BoxSizer(wx.VERTICAL)
        sizer_28 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_29 = wx.BoxSizer(wx.VERTICAL)
        sizer_23 = wx.StaticBoxSizer(wx.StaticBox(self.notebook_3_pane_2, wx.ID_ANY, "Curent"), wx.HORIZONTAL)
        sizer_24 = wx.BoxSizer(wx.VERTICAL)
        sizer_22 = wx.StaticBoxSizer(wx.StaticBox(self.notebook_3_pane_2, wx.ID_ANY, "Read"), wx.HORIZONTAL)
        ...
        sizer_30.Add(label_24, 0, wx.ALIGN_CENTER_VERTICAL | wx.LEFT, 30)
        sizer_30.Add(self.button_zoom_hist_home, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_30.Add(self.button_zoom_hist_back, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_30.Add(self.button_zoom_hist_forward, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_30.Add(self.button_autoscale, 0, wx.ALIGN_CENTER_VERTICAL | wx.LEFT, 4)
        label_22 = wx.StaticText(self.notebook_3_pane_1, wx.ID_ANY, "Picked:")
        sizer_30.Add(label_22, 0, wx.ALIGN_CENTER_VERTICAL | wx.LEFT, 30)
        sizer_30.Add(self.text_picked, 4, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_30.Add(self.checkbox_pick_delete, 0, wx.ALIGN_CENTER_VERTICAL | wx.LEFT | wx.RIGHT, 6)
        ...
        sizer_7.Add(self.shell, 1, wx.EXPAND, 0)
        self.notebook_3_Shell.SetSizer(sizer_7)
        sizer_22.Add(self.list_box_data_folder, 0, 0, 0)
        sizer_2.Add(self.button_adddata, 0, 0, 0)
        sizer_2.Add(self.button_update_folder, 0, 0, 0)
        sizer_2.Add((0, 0), 0, 0, 0)
        sizer_22.Add(sizer_2, 0, wx.ALL | wx.EXPAND, 5)
        sizer_28.Add(sizer_22, 0, wx.ALL | wx.EXPAND, 5)
        sizer_23.Add(self.list_box_currentdata, 0, 0, 0)
        sizer_24.Add(self.button_removedata, 0, 0, 0)
        sizer_24.Add((0, 0), 0, 0, 0)
        sizer_24.Add((0, 0), 0, 0, 0)
        sizer_23.Add(sizer_24, 0, wx.ALL | wx.EXPAND, 5)
        sizer_28.Add(sizer_23, 1, wx.ALL, 5)
        sizer_29.Add(self.button_openfolder, 0, 0, 0)
        sizer_29.Add(self.button_open_cfg, 0, 0, 0)
        sizer_28.Add(sizer_29, 1, wx.ALL | wx.EXPAND, 5)
        sizer_21.Add(sizer_28, 0, 0, 0)
        sizer_25.Add(self.list_box_parax, 0, wx.ALL, 3)
        sizer_25.Add(self.list_box_paray, 0, wx.ALL, 3)
        sizer_26.Add(self.button_1, 0, 0, 0)
        label_34 = wx.StaticText(self.notebook_3_pane_2, wx.ID_ANY, "length to draw")
        sizer_26.Add(label_34, 0, 0, 0)
        sizer_26.Add(self.slider_length, 0, wx.EXPAND, 0)
        label_39 = wx.StaticText(self.notebook_3_pane_2, wx.ID_ANY, "start point to draw")
        sizer_26.Add(label_39, 0, 0, 0)
        sizer_26.Add(self.slider_startpoint, 0, wx.EXPAND, 1)
        sizer_25.Add(sizer_26, 1, wx.ALL | wx.EXPAND, 6)
        sizer_25.Add((0, 0), 0, 0, 0)
        sizer_21.Add(sizer_25, 1, wx.ALL | wx.EXPAND, 5)
        sizer_27.Add(self.button_draw, 0, wx.ALL, 7)
        sizer_27.Add(self.button_popupdraw1, 0, 0, 0)
        sizer_27.Add(self.button_popupdraw2, 0, 0, 0)
        sizer_27.Add(self.button_popupdraw3, 0, 0, 0)
        sizer_21.Add(sizer_27, 0, wx.ALL, 0)
        label_4 = wx.StaticText(self.notebook_3_pane_2, wx.ID_ANY, "f(x) = ")
        ...
        label_19 = wx.StaticText(self.notebook_3_pane_2, wx.ID_ANY, "Subplot position:")
        ...
        sizer_21.Add(sizer_8, 0, wx.ALL, 3)
        label_25 = wx.StaticText(self.notebook_3_pane_2, wx.ID_ANY, "Size:")
        ...
        label_15 = wx.StaticText(self.notebook_3_pane_2, wx.ID_ANY, "Subplots:")
        ...
        sizer_21.Add(sizer_12, 1, wx.ALL | wx.EXPAND, 3)
        sizer_20.Add(sizer_21, 1, wx.EXPAND, 0)
        self.notebook_3_pane_2.SetSizer(sizer_20)
        self.notebook_3.AddPage(self.notebook_3_66, "66")
        self.notebook_3.AddPage(self.notebook_3_pane_1, "GUI")
        self.notebook_3.AddPage(self.notebook_3_Shell, "Shell")
        self.notebook_3.AddPage(self.notebook_3_pane_2, "new tab")
    ...
    def on_button_adddata(self, event):  # wxGlade: MyFrame.<event_handler>
        print("Event handler 'on_button_adddata' not implemented!")
        event.Skip()

    def on_button_update_folder(self, event):  # wxGlade: MyFrame.<event_handler>
        print("Event handler 'on_button_update_folder' not implemented!")
        event.Skip()

    def on_button_removedata(self, event):  # wxGlade: MyFrame.<event_handler>
        print("Event handler 'on_button_removedata' not implemented!")
        event.Skip()

    def on_button_openfolder(self, event):  # wxGlade: MyFrame.<event_handler>
        print("Event handler 'on_button_openfolder' not implemented!")
        event.Skip()

    def on_button_opencfg(self, event):  # wxGlade: MyFrame.<event_handler>
        print("Event handler 'on_button_opencfg' not implemented!")
        event.Skip()

    def on_slider_length(self, event):  # wxGlade: MyFrame.<event_handler>
        print("Event handler 'on_slider_length' not implemented!")
        event.Skip()

    def on_slider_startpoint(self, event):  # wxGlade: MyFrame.<event_handler>
        print("Event handler 'on_slider_startpoint' not implemented!")
        event.Skip()

    def on_button_draw(self, event):  # wxGlade: MyFrame.<event_handler>
        print("Event handler 'on_button_draw' not implemented!")
        event.Skip()

    def on_button_popupdraw1(self, event):  # wxGlade: MyFrame.<event_handler>
        print("Event handler 'on_button_popupdraw1' not implemented!")
        event.Skip()

    def on_button_popupdraw2(self, event):  # wxGlade: MyFrame.<event_handler>
        print("Event handler 'on_button_popupdraw2' not implemented!")
        event.Skip()

    def on_button_popupdraw3(self, event):  # wxGlade: MyFrame.<event_handler>
        print("Event handler 'on_button_popupdraw3' not implemented!")
        event.Skip()
